          ...
          <SignIn
            ...
            appearance={{
              ...
              variables: {
                ...
                colorBackground: "transparent", // Card handles background
              ...
              elements: {
                ...
                // Header
                headerTitle:
                  "text-2xl font-bold text-neutral-900 dark:text-white text-center",
                headerSubtitle:
                  "text-neutral-600 dark:text-neutral-300 text-center mt-1",

                // Form Box (Inner Container)
                formBox:
                  "bg-white/10 dark:bg-neutral-900/30 backdrop-blur-md border border-white/20 dark:border-neutral-700 rounded-lg shadow-lg p-4",
                ...
                // Labels
                formFieldLabel:
                  "text-neutral-700 dark:text-neutral-200 text-sm font-medium mb-1",
